...
const DATA_URL = {
  TRIPS:
    'https://raw.githubusercontent.com/happy956/trip/master/src/json/trips.json',
  EMPTY:
    'https://raw.githubusercontent.com/happy956/trip/master/src/json/empty.json',
  PERSON:
    'https://raw.githubusercontent.com/happy956/trip/master/src/json/ps_loc_inf.json'
};
...
function renderLayers(props) {
  ...
  return [
    ...
    new ScatterplotLayer({
      id: 'scatterplot',
      data: emptyArr, // load data from server
    ...
    new ScatterplotLayer({
      id: 'scatterplot',
      data: psArr, // load data from server
      getPosition: (d) => [d[0], d[1]], // get lng,lat from each point
      getFillColor: (d) => [100, 220, 150],
      getRadius: (d) => 25,
      opacity: 0.9,
      pickable: false,
      radiusMinPixels: 3,
...
export default function Main() {
  ...
  return (
    <div>
      <DeckGL
        layers={renderLayers({'empty':empty, 'ps':ps, 'time':time})}
